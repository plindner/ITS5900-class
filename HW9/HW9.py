...
def process_dir(p, indent):
    ...
    try:
        ...
        for item in os.listdir(p):
            ...
            # '0' being the path, '1' being the directory:
                ...
                # the other directories and increase the indent size by 1,
                # giving a tree like output of the system path.
    ...
    # For any other errors
        ...
        # Inform the user that their input is Invalid for this function
        print("Invalid input")
